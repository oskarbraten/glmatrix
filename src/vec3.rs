...
impl Vec3<f32> {
    ...
    /// Creates a Vec3<f32> from a slice of 16 bytes.
    pub fn from_bytes(bytes: &[u8; 12]) -> Self {
        let mut elements = [0.0f32; 3];
        for i in 0..3 {
...
impl Vec3<f64> {
    ...
    /// Creates a Vec3<f64> from a slice of 32 bytes.
    pub fn from_bytes(bytes: &[u8; 24]) -> Self {
        let mut elements = [0.0f64; 3];
        for i in 0..3 {
...
impl<T, Index> std::ops::IndexMut<Index> for Vec3<T>
where
    Index: std::slice::SliceIndex<[T]>
{

...
impl Vec2<f32> {
    ...
    /// Creates a Vec2<f32> from a slice of 16 bytes.
    pub fn from_bytes(bytes: &[u8; 8]) -> Self {
        let mut elements = [0.0f32; 2];
        for i in 0..2 {
...
impl Vec2<f64> {
    ...
    /// Creates a Vec2<f64> from a slice of 32 bytes.
...
impl<T, Index> std::ops::IndexMut<Index> for Vec2<T>
where
    Index: std::slice::SliceIndex<[T]>
{
